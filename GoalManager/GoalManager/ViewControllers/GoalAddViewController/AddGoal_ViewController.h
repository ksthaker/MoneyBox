...
@interface AddGoal_ViewController : UIViewController<UITextFieldDelegate,UIScrollViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPickerViewDataSource,UIPickerViewDelegate,VPImageCropperDelegate,UIActionSheetDelegate,GADInterstitialDelegate>
{
    BOOL isSetReminder;
    BOOL isInternet;
...
@property(nonatomic,weak)IBOutlet GADBannerView *view_AD;
...
@property(nonatomic,weak)IBOutlet UILabel *lbl_add_photo;
...
@property (strong, nonatomic)Goal *goalAdd;
